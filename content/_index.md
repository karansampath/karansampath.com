...
<p class="display-5 fw-bold h3 text-left">About Me</p>
...
<p>  {{% paige/image alt="Potrait" breakpoints=true fetchpriority="high" height="40rem" loading="eager" process="webp" src="/images/profile.png" width="100%" %}}</p>
